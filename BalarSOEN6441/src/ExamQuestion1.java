...
public class ExamQuestion1 {
	...
	public static void main(String[] args) {
		...
		// Subtask a)
		List<Course> fourCreditCourses = ExamTask.replaceWithYourSolution();
		System.out.println("a) " + fourCreditCourses);

		// Subtask b)
		int sumCredits = ExamTask.replaceWithYourSolution();
		System.out.println("b) " + sumCredits);

		// Subtask c)
		boolean hasMegaCourse = ExamTask.replaceWithYourSolution();
		System.out.println("c) " + hasMegaCourse);
		
		// Subtask d)
		Optional<Course> c6441 = ExamTask.replaceWithYourSolution();
		System.out.println("d) " + c6441);
		
		// Subtask e)
		Set<String> courseWords = ExamTask.replaceWithYourSolution();
