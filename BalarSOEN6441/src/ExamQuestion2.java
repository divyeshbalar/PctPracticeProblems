...
public class ExamQuestion2 {
	...
	public static void main(String[] args) {
		...
		// Subtask a)
		Map<Program, List<Course>> coursesByType = ExamTask.replaceWithYourSolution();
		System.out.println("a) " + coursesByType);
		
		// Subtask b)
		Map<Boolean, List<Course>> partitionedCourses = ExamTask.replaceWithYourSolution();
		System.out.println("b) " + partitionedCourses);
		
		// Subtask c)
		final Course courseLongestName = ExamTask.replaceWithYourSolution();  
